...
export function TermsOfUseModa() {
	return (
		<DialogContent className="overflow-auto sm:w-full sm:max-w-xl">
			<DialogHeader>
				<DialogTitle className="text-2xl">Términos de Uso</DialogTitle>
			</DialogHeader>
			...
			<div className="space-y-4">
				...
				<p>
					...
					nuestros productos. talenthub.com no asume la responsabilidad en caso
				...
				<section className="space-y-2">
					<h3 className="text-xl font-bold">Licencia</h3>

					<p>
						TalentHub a través de su sitio web concede una licencia para que los
				...
				<section className="space-y-2">
					<h3 className="text-xl font-bold">Uso no autorizado</h3>
				...
				<section className="space-y-2">
					<h3 className="text-xl font-bold">Propiedad</h3>
				...
				<section className="space-y-2">
					<h3 className="text-xl font-bold">Comprobación Antifraude</h3>
				...
				<section className="space-y-2">
					<h3 className="text-xl font-bold">Privacidad</h3>

					<p>
						Este talenthub.com garantiza que la información personal que usted
					...
					<p>
						TalentHub reserva los derechos de cambiar o de modificar estos
					...
					<p>
						...
						administración de la cuenta en cualquier momento, en caso de que se
						haya registrado y que sea necesario para la compra de alguno de
						nuestros productos. talenthub.com no asume la responsabilidad en
