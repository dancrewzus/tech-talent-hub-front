		...
		<div className="space-y-4">
			<Accordion type="single" collapsible className="w-full">
				<AccordionItem value="item-1">
					...
					<AccordionContent>
						En general, todos los miembros que se conecten a Tech Talent Hub
						pueden ver tu perfil completo. Sin embargo, si se puede controlar lo
						que aparece en su perfil, las notificaciones a su red y las
						preferencias de privacidad de su perfil. También puede editar su
						perfil o mostrar su experiencia y educación o agregar
						recomendaciones y habilidades para resaltar detalles como su
						experiencia.
					</AccordionContent>
				</AccordionItem>
				...
				<AccordionItem value="item-3">
					...
					<AccordionContent>
						...
						<ul className="mt-2 list-disc space-y-2 [&>li]:ml-4">
							...
							<li>
								Verifica la dirección de email asociada a tu cuenta de Tech
								Talent Hub.
							</li>
